 ...
 * stores the ID of the VAO (Vertex Array Object) that holds the model's vertex
 * data, as well as the count of vertices that make up the model.
 * 
 * This class is primarily used for storing and accessing model data during
 * rendering.
 */
